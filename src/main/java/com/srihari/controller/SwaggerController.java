...
public class SwaggerController
{
        ...
        {  
            return new Docket(DocumentationType.SWAGGER_2)
                    .apiInfo(apiInfo())
                    .groupName("ShopforHome")
                    .select().apis(RequestHandlerSelectors.basePackage("com.srihari.controller"))  
                    .build()
        ...
        {  // used this object to store the meta data
            return new ApiInfoBuilder().title("ShopforHome")
                    .description("ShopforHomeOwner")
                    .build();
        }
